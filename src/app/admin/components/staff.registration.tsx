...
import { FilePreviewForStaff, StaffFormErrors, StaffRegistrationForm } from '@/app/components/types/data.types'
import { InitialStaffFormState } from '@/app/components/data/constant'
import { validateStaffForm } from '@/app/validation/staff.validation'
